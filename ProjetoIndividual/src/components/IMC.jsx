...
export default function IMC() {
  ...
  function CalcularImc(event) {
    ...
    setResposta(
      `${nome} com a sua altura de ${altura} cm e seu peso de ${peso}Kg você está com ${resultado}`
    );
    console.log(
      `Com a sua altura de ${altura} cm e seu peso de ${peso}Kg você está com ${resultado}`
    );
  }
